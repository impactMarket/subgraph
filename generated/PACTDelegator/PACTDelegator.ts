...
export class PACTDelegator extends ethereum.SmartContract {
  ...
  proposalTargets(param0: BigInt, param1: BigInt): Address {
    let result = super.call(
      "proposalTargets",
      "proposalTargets(uint256,uint256):(address)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
        ethereum.Value.fromUnsignedBigInt(param1)
      ]
  ...
  proposalValues(param0: BigInt, param1: BigInt): BigInt {
    let result = super.call(
      "proposalValues",
      "proposalValues(uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
        ethereum.Value.fromUnsignedBigInt(param1)
      ]
  ...
  releaseToken(): Address {
    let result = super.call("releaseToken", "releaseToken():(address)", []);

    return result[0].toAddress();
  }

  try_releaseToken(): ethereum.CallResult<Address> {
    let result = super.tryCall("releaseToken", "releaseToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
