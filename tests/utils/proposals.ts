...
import { ProposalCreated, ProposalQueued } from '../../generated/PACTDelegator/PACTDelegator';
...
export function createProposalCreatedEvent(
    ...
    const valuesParam = new ethereum.EventParam('values', ethereum.Value.fromUnsignedBigIntArray(_values));
...
export function createProposalQueuedEvent(id: i32): ProposalQueued {
    ...
    proposalCreatedEvent.parameters = [];
    const idParam = new ethereum.EventParam('id', ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(id)));
    const etaParam = new ethereum.EventParam('eta', ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(0)));
