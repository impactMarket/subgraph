...
test('add manager', () => {
    ...
    const managerAddedEvent1 = createManagerAddedEvent(managerAddress[0], managerAddress[1], communityAddress[0]);

    const managerAddedEvent2 = createManagerAddedEvent(managerAddress[0], managerAddress[2], communityAddress[0]);
...
test('remove manager', () => {
    ...
    const managerRemovedEvent1 = createManagerRemovedEvent(managerAddress[0], managerAddress[1], communityAddress[0]);
    ...
    assert.fieldEquals('CommunityDailyEntity', `${communityAddress[0]}-${dayId}`, 'managers', '1');
...
test('remove manager', () => {
    ...
    const managerAddedEvent3 = createManagerAddedEvent(managerAddress[0], managerAddress[1], communityAddress[0]);
