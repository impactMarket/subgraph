...
export function handleOldCommunityAdded(event: OldCommunityAdded): void {
    generiHandleCommunityAdded(
        ...
        BigInt.fromI32(0),
        event.params._baseInterval.gt(BigInt.fromI32(500000)) ? 0 : event.params._baseInterval.toI32(),
        event.params._incrementInterval.gt(BigInt.fromI32(500000)) ? 0 : event.params._incrementInterval.toI32(),
        BigInt.fromI32(0),
        BigInt.fromI32(0),
